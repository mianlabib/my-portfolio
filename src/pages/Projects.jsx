          ...
          <div className="flex flex-col">
            {projects.map((project, index) => (
              <a
                ...
                className="drop-shadow-md card bg-white rounded-lg px-5 mb-3 py-3 gap-x-3 flex flex-col md:flex-none md:flex-row hover:-translate-y-1 hover:scale-100 duration-300 transition ease-in-out delay-150 hover:shadow-sm border border-gray-200 hover:border-gray-300"
                href=""
              >
